...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center h-screen text-center bg-gray-900">
      {/* Imagen */}
      <img
        src="https://lh3.googleusercontent.com/a/AAcHTtc7M2x6sGEHeMj85wimVuPHlKYMEgx5Ciowmn1I=s96-c" // Cambia esto por la ruta de tu imagen
        alt="Me"
        className="w-32 h-32 rounded-full border-4 border-yellow-400 shadow-lg mb-6"
      />

      {/* Texto principal */}
      <h1 className="text-5xl font-bold text-yellow-400">Hola, soy Fernando Marcos</h1>
      <p className="mt-4 text-xl text-gray-300">
        Estudiante de Diseño y Desarrollo de Software en Tecsup. <br />
        Me apasiona crear soluciones digitales innovadoras.
      </p>
      ...
      <div className="mt-6 flex space-x-6">
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/marcos-chocce/" // Cambia esto por tu perfil de LinkedIn
          target="_blank"
        ...
        {/* GitHub */}
        <a
          href="https://github.com/MarcosFernandoCJ" // Cambia esto por tu perfil de GitHub
          target="_blank"
          rel="noopener noreferrer"
          className="hover:opacity-75"
        >
        ...
        {/* Correo */}
        <a
          href="mailto:marcoschocce2828@gmail.com" // Cambia esto por tu correo electrónico
          className="hover:opacity-75"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
